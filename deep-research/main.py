...
def create_prefix_message():
    return [
        ChatMessage(
            ...
            content=(
                """
                You are a very-well experienced and sophisticated research assistant. Perform comprehensive research on the given query and provide detailed analysis. Focus on:
                ...
                Ensure all information is accurate, up-to-date, along with iron-clad sources. Present the findings in a clear, structured format suitable for professional analysis.
                """
            ),
        )
    ]
...
def chatbot():
    print("🤖: Hi! I can help you research any topic.")
    ...
    questions_prompt = f"""
    Generate 6-8 specific questions about the topic to help guide the research agent to research about the topic: {topic} and this is the domain: {domain}, so don't ask too complex probing questions(if you do, break them down into simpler first principle questions), keep them relatively simple. Use first principles and Focus on:
