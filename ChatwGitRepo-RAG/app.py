            ...
            with tempfile.TemporaryDirectory() as temp_dir:
                ...
                if file_key not in st.session_state.get('file_cache', {}):
                    ...
                    if os.path.exists(temp_dir):
                        # Gitingest returns a markdown, summary and the content related to the Github URL provided
                    ...
                    # Prompt 
                    qa_prompt_tmpl_str = """
                    You are now an Expert Software Engineer with years of experience working proficiently with large, scalable and available systems. 
                    Act as an assitant who is specialised in analyzing GitHub repositories, help work with them in simple yet detailed manner.
                    ...
                    Given the repository structure and context above, provide a clear and precise answer to the user query. 
                    [MUST] Focus on the repository's content, code structure, and implementation details. 
...
with col1:
    st.header(f"Chat with GitHub Repos")
